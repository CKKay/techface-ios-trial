...
-(void) updateVersion{
    ...
    NSURL *URL = [NSURL URLWithString:@"itms-apps://itunes.apple.com/us/app/apple-store/id1503292387?mt=8"];
...
- (void)executeInBackgroundHomeconfig {
    ...
    NSURL *url = [Server url:@"/techface_api/getPractitioners?company_id=%@&company_user_id=%@&tf_token=%@", company_id, comp_user_id,tf_token];
